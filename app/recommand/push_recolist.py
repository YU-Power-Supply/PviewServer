...
### 추천테이블 삽입 ###
df = pd.read_excel("/home/ubuntu/PviewServer/app/recommand/recolist.xlsx", index_col=0)
...
### 화장품테이블 삽입 ###
df = pd.read_excel("/home/ubuntu/PviewServer/app/recommand/cosdf_to_db.xlsx", index_col=0)
df['created_at'] = datetime.now()
